...
var executeSettlement = (runtime2, match) => {
  ...
  try {
    ...
    runtime2.log(`   Buyer commitment: ${match.buyOrder.walletCommitment}`);
    runtime2.log(`   Seller commitment: ${match.sellOrder.walletCommitment}`);
    runtime2.log(`   Settlement contract: ${config.otcSettlementAddress}`);
    runtime2.log(`   ✅ Settlement prepared (awaiting contract deployment)`);
  } catch (error) {
